...
import {Form, Collapse, Typography, Row, Col, Button, Spin, notification, Select, Input} from 'antd';
                ...
                <Panel  showArrow={false} header="Project details" key="project-details">
                    ...
                    >
                        <Form.Item 
                            ...
                            rules={[{required: true}]}
                        >
                            <Input readOnly placeholder='Project name'  size='large' suffix={<i className='icon-hvh-clipboard' />} />
                        </Form.Item> 
                        <Form.Item
